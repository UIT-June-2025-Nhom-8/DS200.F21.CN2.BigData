...
| 140k-StyleGAN chiếm phần lớn (~44%) tổng thể | Lấy mẫu cân bằng theo nguồn khi huấn luyện để tránh mô hình chỉ học phong cách ảnh StyleGAN (lấy mẫu phân tầng theo nguồn) |
...
| -------------------------------------------- | -------------------------------------------------------------------- |
| 140k-StyleGAN chiếm ~44% tổng thể            | Lấy mẫu cân bằng theo nguồn khi huấn luyện (tránh thiên vị StyleGAN) |
