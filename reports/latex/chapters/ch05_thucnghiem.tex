...
\begin{table}[H]
  ...
  \begin{tabular}{lrrr}
    ...
    \midrule
    140k-StyleGAN & [INSERT] & [INSERT] & [INSERT] \\
    Deepfake-Real & [INSERT] & [INSERT] & [INSERT] \\
    Hard-FakeReal & [INSERT] & [INSERT] & [INSERT] \\
    ciplab        & [INSERT] & [INSERT] & [INSERT] \\
    \bottomrule
  \end{tabular}
  \newline
  {\small Nguồn: \texttt{reports/cross\_generator/} (chưa có kết quả)}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrr}
    ...
    JPEG nén $q=70$        & [INSERT] & [INSERT] & [INSERT] \\
    JPEG nén $q=50$        & [INSERT] & [INSERT] & [INSERT] \\
    JPEG nén $q=30$        & [INSERT] & [INSERT] & [INSERT] \\
    Downscale 50\%         & [INSERT] & [INSERT] & [INSERT] \\
    Downscale 25\%         & [INSERT] & [INSERT] & [INSERT] \\
    Gaussian blur $\sigma=1$ & [INSERT] & [INSERT] & [INSERT] \\
    Gaussian blur $\sigma=2$ & [INSERT] & [INSERT] & [INSERT] \\
    \bottomrule
  \end{tabular}
  \newline
  {\small Nguồn: \texttt{reports/robustness/} (chưa có kết quả)}
\end{table}
...
[INSERT: kết quả Grad-CAM từ \texttt{artifacts/gradcam/} khi có]

Dựa trên quan sát EDA, kỳ vọng mô hình tập trung vào: vùng tai và hoa tai (artifact StyleGAN2 phổ biến nhất), vùng tiếp giáp tóc--da, và nền ảnh gần mặt.
