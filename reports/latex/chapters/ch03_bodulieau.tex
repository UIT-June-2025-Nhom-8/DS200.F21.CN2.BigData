...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{lXll}
    ...
    Deepfake-Real  & \texttt{deepfake-and-real-images/}  & [INSERT] ảnh $256{\times}256$ & Manipulation-based \\
    Hard-FakeReal  & \texttt{hardfakevsrealfaces/}        & [INSERT] ảnh & GAN bậc cao \\
    ciplab         & \texttt{real-and-fake-face-detection/} & [INSERT] ảnh & Nhiều phương pháp GAN \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{enumerate}
  \item \textbf{Suy ra nhãn từ cấu trúc thư mục:} Nhãn $0$ (thật) gán cho thư mục \texttt{real}, \texttt{Real}, \texttt{training\_real}; nhãn $1$ (giả) gán cho \texttt{fake}, \texttt{Fake}, \texttt{training\_fake}.
...
Schema CSV: mỗi hàng gồm \texttt{image\_path} (đường dẫn tuyệt đối) và \texttt{label} (số nguyên: $0$ = thật, $1$ = giả).
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    \textbf{Tổng cộng} & \textbf{316.530} & \textbf{149.741} & \textbf{166.789} & \textbf{0,898} \\
    \bottomrule
  \end{tabular}
\end{table}
